-- Supabase (PostgreSQL) Database Schema for CALTRACK AI
-- Drop tables if they exist (for easy seeding/resets)
...
CREATE TABLE public.meals (
  ...
  name TEXT NOT NULL, -- e.g., "Protein Power Bowl", "Avocado Toast with Eggs"
...
CREATE TABLE public.meal_items (
  ...
  name TEXT NOT NULL,
  portion TEXT NOT NULL, -- e.g., "1 large egg", "120g generic chicken breast"
  ...
  confidence DECIMAL(4,3), -- e.g., 0.95 confidence from vision AI scanner
  category TEXT DEFAULT 'Generic', -- e.g., "Poultry", "Beverage"
  image_uri TEXT, -- camera image path
